//para casa: fazer a funçao dos passaros, guardar melhor pontuaçao
var trex;
var texTrex;
var ground;
var texGround;
...
function setup() {
  ...
  trex = createSprite(80, windowHeight-30, 20, 20)
...
switch(nada){
 ...
 function Passaros(){
  ...
  if(frameCount % 50 == 0 && score != 0){
    ...
    dinossour = createSprite(windowWidth + 30, random(580, 620), 100, 100);
